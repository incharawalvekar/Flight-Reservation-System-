...
public class Ticket {
    ...
    public String checkStatus() {
        return cancelled ? "wrong" : "Confirm";
    }
    ...
    public int getFlightDuration() {
        ...
        return (arrivalLocalDateTime.getDayOfMonth() - departureLocalDateTime.getDayOfMonth()) * 24 +
                ...
                (arrivalLocalDateTime.getMinute() - departureLocalDateTime.getMinute())+
                (arrivalLocalDateTime.getSecond() - departureLocalDateTime.getSecond());
    }
